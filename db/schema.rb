...
ActiveRecord::Schema[7.0].define(version: 20_241_118_171_601) do
    ...
    create_table 'entities_users', id: false, force: :cascade do |t|
        t.integer 'entity_id'
        t.integer 'user_id'
        t.index %w[entity_id user_id], name: 'index_entities_users_on_entity_id_and_user_id', unique: true
    ...
    create_table 'vendor_reviews', force: :cascade do |t|
        ...
        t.datetime 'created_at', null: false
        t.datetime 'updated_at', null: false
        t.index %w[user_id vendor_id], name: 'index_vendor_reviews_on_user_id_and_vendor_id', unique: true
